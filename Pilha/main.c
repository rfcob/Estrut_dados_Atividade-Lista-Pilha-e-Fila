...
void exibir_FILO(PILHA* p) {
    exibirPilha(p);
}


//___________________________________Fnção chamando impressão da base para o topo 

void exibir_FIFO(PILHA* p){
