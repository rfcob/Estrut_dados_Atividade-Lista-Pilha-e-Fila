...
//____________________________________________________________________________________________________________________________________
//____________________________________________________________________________________________________________________________________
// Implementação da impressão pilha invertida


//A implementação foi simples, uma vez que é apenas uma inversão no for. Isso simplifica, ja que a pilha 
//está estaticamente implementada usando-se um array de máximo 50 posições.
